...
#define INPUT_BUFFER_SIZE 10000 //test: 100 bytes of buffer
...
public:
    ...
    void onInput(void (*rc)(uint16_t fd, char *buffer, int nbytes));
...
private:
    ...
    void (*receiveCallback) (uint16_t fd, char *buffer, int n);
